...
VALUES
('Aarav Sharma', 'aarav.sharma@example.com', 'pass123', '9876543210'),
('Priya Verma', 'priya.verma@example.com', 'pass456', '9876543211'),
('Rahul Singh', 'rahul.singh@example.com', 'pass789', '9876543212'),
('Ananya Mishra', 'ananya.mishra@example.com', 'pass321', '9876543213'),
('Rohan Gupta', 'rohan.gupta@example.com', 'pass654', '9876543214'),
('Sneha Patel', 'sneha.patel@example.com', 'pass987', '9876543215'),
('Aditya Yadav', 'aditya.yadav@example.com', 'pass147', '9876543216'),
('Kavya Joshi', 'kavya.joshi@example.com', 'pass258', '9876543217'),
('Vivek Kumar', 'vivek.kumar@example.com', 'pass369', '9876543218'),
('Pooja Sharma', 'pooja.sharma@example.com', 'pass111', '9876543219');

INSERT INTO Address (CustomerID, HouseNo, Street_Block, Area, City, Province, PostalCode, Country)
VALUES
(1, 12, 'Sector 15', 'Rohini', 'New Delhi', 'Delhi', '110089', 'India'),
(2, 45, 'Sector 22', 'Nerul', 'Navi Mumbai', 'Maharashtra', '400706', 'India'),
(3, 67, 'Kankarbagh', 'Patna City', 'Patna', 'Bihar', '800020', 'India'),
(4, 78, 'Hazratganj', 'Aliganj', 'Lucknow', 'Uttar Pradesh', '226024', 'India'),
(5, 23, 'Salt Lake', 'Bidhannagar', 'Kolkata', 'West Bengal', '700091', 'India'),
(6, 89, 'Sector 17', 'Chandigarh', 'Chandigarh', 'Chandigarh', '160017', 'India'),
(7, 34, 'Banjara Hills', 'Jubilee Hills', 'Hyderabad', 'Telangana', '500033', 'India'),
(8, 90, 'Koramangala', 'HSR Layout', 'Bengaluru', 'Karnataka', '560102', 'India'),
(9, 11, 'Vaishali Nagar', 'Malviya Nagar', 'Jaipur', 'Rajasthan', '302017', 'India'),
(10, 56, 'Kothrud', 'Shivaji Nagar', 'Pune', 'Maharashtra', '411038', 'India');
